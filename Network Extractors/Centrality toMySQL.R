...
for(courseID in courseIDs){
   ...
   sql<-paste("insert into uoe_centrality (forum_user_id, pc_degree, pc_indegree, pc_outdegree, pc_betweenness, pc_eigenvector,
                        pset_degree, pset_betweenness, pset_eigenvector)   values (",
              paste(paste("'",row,"'",sep=""),
              pc.df[row,"pc_degree"],
              ...
              pset.df[row,"pset_eigenvector"], sep=","),")")
