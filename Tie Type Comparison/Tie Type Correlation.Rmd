...
Isolates are removed. Specifically, nodes that are isolates in both are removed. These are people who post and who got no comments, and never comment on anyone else's posts. There may be quite a lot of these and including them distorts attempts to assess correlation. 
